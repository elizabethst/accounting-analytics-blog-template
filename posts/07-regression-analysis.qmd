...
set.seed(2026107)         # Reproducible results
```
...
financial_data <- read_csv("https://estanny.org/data/2026-fall/07_company_financial_data.csv")
...
activity_levels <- tibble(
  ...
  employee_count = round(mean(expense_data$employee_count))
)
