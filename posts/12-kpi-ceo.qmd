...
Revenue of $_______M exceeded target by _______% (+_______% YoY) and stock price up _______% to $_______, yet _______ of five strategic KPIs trail targets—EBITDA margin at _______% (-0.8pp vs target), market share slipping to _______% (-0.2pp YoY) as Competitor A maintains its _______% lead, and NPS stalled at _______ despite 5.9% improvement—revealing a growth-profitability tension where top-line momentum is outpacing operational efficiency gains. The Enterprise segment ($425M, _______% growth, _______% margin) continues to drive disproportionate value creation, while two critical digital initiatives are faltering: _______ at 35% completion (At Risk, Critical Impact) and _______ at 45% (Behind, High Impact), threatening the operational leverage needed to close the margin gap. The 5-year forecast projects revenue reaching $_______B by 2028 with EBITDA margins expanding to _______% in the base case.
...
_______(share_plot, tooltip = c("x", "y"))  
```
...
customer_plot <- customer_metrics |>
  ggplot(_______(x = performance, y = metric, fill = status)) +
...
scenario_data <- scenarios |>
  _______(scenario, revenue_2028, ebitda_2028) |>
