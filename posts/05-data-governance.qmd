...
transactions <- tribble(
  ...
  "T001",    "2025-03-15", 1,           6300,   0,       "Customer payment",
  "T002",    "2025-03-15", 5,           0,      6300,    "Sales revenue",
  "T003",    "03/20/2025", 6,           2100,   0,       "Rent payment",
  "T004",    "2025-03-32", 3,           0,      2100,    "Rent payable",
  "T005",    "2025-03-25", 83,          800,    0,       "Office supplies",  # Invalid account
  "T006",    "2025-03-25", 2,           0,      800,     "Customer invoice",
  "T007",    "2025-03-28", 91,          800,    0,       "Misc expense",     # Invalid account
  "T008",    "2025-03-28", 1,           0,      800,     "Misc accrual"
)
...
# Test dates
test_dates <- c("03/20/2025", "2023-06-30", "2028-01-01", "2027-13-01", "2019-01-01")
...
- **Data Quality Issues Found**: The sample transactions had _____ invalid account reference(s).
- **Date Validation**: There were _____ valid dates and _____ non-valid dates (out of 5).
- **Referential Integrity**: _____ transaction(s) referenced non-existent accounts and _____ transaction day(s) were unbalanced.
