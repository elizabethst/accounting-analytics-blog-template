...
financial_data <- read_rds("https://estanny.org/data/2026-fall/09-assignment-financial_data.rds")
...
2. **Profitability Trends**:
   ...
   - Operating margin has moved from _____ to _____, showing _____
